...
__sysy_par_body_1:
	...
	ldr w5, [x9, :lo12:__sysy_par_ctx_1_0]
	adrp x11, __sysy_par_ctx_1_2
	ldr x8, [x11, :lo12:__sysy_par_ctx_1_2]
	adrp x12, __sysy_par_ctx_1_1
	adrp x10, __sysy_par_ctx_1_3
	adrp x9, __sysy_par_ctx_1_4
	ldr w7, [x12, :lo12:__sysy_par_ctx_1_1]
	ldr x17, [x10, :lo12:__sysy_par_ctx_1_3]
	ldr w16, [x9, :lo12:__sysy_par_ctx_1_4]
	mov w4, w0
	mov w6, w1
	add w15, w5, #1
	movz w11, #5600
...
.L__sysy_par_body_1_bb3:
	...
	sub w0, w14, #1
	cset w19, ge
	cbz w19, .L__sysy_par_body_1_bb6
.L__sysy_par_body_1_bb4:
	smaddl x9, w2, w11, x17
	add x12, x9, w14, sxtw #2
	ldr w10, [x12]
	ldr w9, [x9, w0, sxtw #2]
	cmp w10, w9
...
.L__sysy_par_body_1_bb6:
	cmp w3, w16
	cset w1, lt
	cbz w1, .L__sysy_par_body_1_bb9
.L__sysy_par_body_1_bb7:
	smaddl x10, w2, w11, x17
	smaddl x9, w3, w11, x17
	add x12, x10, w14, sxtw #2
	ldr w10, [x12]
	ldr w9, [x9, w14, sxtw #2]
	cmp w10, w9
...
.L__sysy_par_body_1_bb10:
	cbz w1, .L__sysy_par_body_1_bb16
...
.L__sysy_par_body_1_bb17:
	movz w9, #5600
	smaddl x10, w2, w9, x17
	add w12, w2, #2
	smaddl x9, w12, w9, x17
	add w12, w15, w7
	sub w12, w12, w13
	add x1, x9, w12, sxtw #2
	add x2, x10, w3, sxtw #2
	add x0, x10, w14, sxtw #2
	movz x9, #5600
