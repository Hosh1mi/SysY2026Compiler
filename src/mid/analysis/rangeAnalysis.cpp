...
//         BasicBlock *join = immediatePostDom(bb);
//         if (!join) continue;

//         for (unsigned i = 1; i <= 2; ++i) {
//             auto *succ = static_cast<BasicBlock *>(br->get_operand(i));
//             if (!succ || succ == join) continue;
...
//                 auto *cur = q.front();
//                 q.pop();
//                 if (cur == join) continue;

//                 bool taken = (i == 1);
//                 PredicateFact fact;
//                 fact.branchTaken = taken;
...
//                     fact.rhs = nullptr;
//                     fact.pred = taken ? ICmpInst::ICMP_NE : ICmpInst::ICMP_EQ;
//                 }
